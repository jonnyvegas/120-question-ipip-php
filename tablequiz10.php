...
<div class="container">
    <h1 class="text-center">This is page 10 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz11.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">46. I am afraid to draw attention to myself.</td>
            ...
            <tr>
                <td class="questions">47. I am always on the go.</td>
            ...
            <tr>
                <td class="questions">48. I prefer to stick with things that I know.</td>
            ...
            <tr>
                <td class="questions">49. I yell at people.</td>
            ...
            <tr>
                <td class="questions">50. I do more than what's expected of me.</td>
    ...
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="10"
                 aria-valuemin="0" aria-valuemax="24" style="width:42%">
                42%
            </div>
        </div>
    </div>
