...
<div class="container">
    <h1 class="text-center">This is page 20 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz21.php" action="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">96. I am not easily annoyed.</td>
                <td style="text-align:center"><input type="radio" name="n2" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="n2" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">97. I avoid crowds.</td>
                <td style="text-align:center"><input type="radio" name="e2" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="e2" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">98. I do not enjoy going to art museums.</td>
                <td style="text-align:center"><input type="radio" name="o2" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="o2" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">99. I obstruct others' plans.</td>
            ...
            <tr>
                <td class="questions">100. I leave my belongings around.</td>
    ...
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="20"
                 aria-valuemin="0" aria-valuemax="24" style="width:83%">
                83%
            </div>
        </div>
    </div>
