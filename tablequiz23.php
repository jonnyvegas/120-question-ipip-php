...
<div class="container">
    <h1 class="text-center">This is page 23 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz24.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">111. I am able to control my cravings.</td>
            ...
            <tr>
                <td class="questions">112. I act wild and crazy.</td>
            ...
            <tr>
                <td class="questions">113. I am not interested in theoretical discussions.</td>
            ...
            <tr>
                <td class="questions">114. I boast about my virtues.</td>
            ...
            <tr>
                <td class="questions">115. I have difficulty starting tasks.</td>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="23"
                 aria-valuemin="0" aria-valuemax="24" style="width:96%">
                96%
            </div>
        </div>
    </div>
