...
<div class="container">
    <h1 class="text-center">This is page 22 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz23.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">106. I am not bothered by difficult social situations.</td>
                <td style="text-align:center"><input type="radio" name="n4" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="n4" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">107. I like to take it easy.</td>
                <td style="text-align:center"><input type="radio" name="e4" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="e4" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">108. I am attached to conventional ways.</td>
            ...
            <tr>
                <td class="questions">109. I get back at others.</td>
            ...
            <tr>
                <td class="questions">110. I put little time and effort into my work.</td>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="22"
                 aria-valuemin="0" aria-valuemax="24" style="width:92%">
                92%
            </div>
        </div>
    </div>
