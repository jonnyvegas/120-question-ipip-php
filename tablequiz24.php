...
<div class="container">
    <h1 class="text-center">This is page 24 (and the last!) of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="results.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">116. I remain calm under pressure.</td>
                <td style="text-align:center"><input type="radio" name="n6" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="n6" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">117. I look at the bright side of life (Monty Python!).</td>
            ...
            <tr>
                <td class="questions">118. I believe that we should be tough on crime.</td>
            ...
            <tr>
                <td class="questions">119. I try not to think about the needy.</td>
            ...
            <tr>
                <td class="questions">120. I act without thinking.</td>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="24"
                 aria-valuemin="0" aria-valuemax="24" style="width:100%">
                100%
            </div>
        </div>
    </div>
