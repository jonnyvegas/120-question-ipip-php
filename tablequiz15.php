...
<div class="container">
    <h1 class="text-center">This is page 15 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz16.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">71. I am often down in the dumps.</td>
            ...
            <tr>
                <td class="questions">72. I take control of things.</td>
            ...
            <tr>
                <td class="questions">73. I rarely notice my emotional reactions.</td>
            ...
            <tr>
                <td class="questions">74. I am indifferent to the feelings of others.</td>
            ...
            <tr>
                <td class="questions">75. I break rules.</td>
    ...
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="15"
                 aria-valuemin="0" aria-valuemax="24" style="width:63%">
                63%
            </div>
        </div>
    </div>
