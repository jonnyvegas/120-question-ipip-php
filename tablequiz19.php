...
<div class="container">
    <h1 class="text-center">This is page 19 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz20.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">91. I get stressed out easily.</td>
            ...
            <tr>
                <td class="questions">92. I keep others at a distance.</td>
            ...
            <tr>
                <td class="questions">93. I like to get lost in thought.</td>
            ...
            <tr>
                <td class="questions">94. I distrust people.</td>
                <td style="text-align:center"><input type="radio" name="a1" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="a1" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">95. I know how to get things done.</td>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="19"
                 aria-valuemin="0" aria-valuemax="24" style="width:79%">
                79%
            </div>
        </div>
    </div>
