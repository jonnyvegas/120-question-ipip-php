...
<div class="container">
    <h1 class="text-center">This is page 14 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz15.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">66. I lose my temper.</td>
            ...
            <tr>
                <td class="questions">67. I prefer to be alone.</td>
            ...
            <tr>
                <td class="questions">68. I do not like poetry.</td>
            ...
            <tr>
                <td class="questions">69. I take advantage of others.</td>
            ...
            <tr>
                <td class="questions">70. I leave a mess in my room.</td>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="14"
                 aria-valuemin="0" aria-valuemax="24" style="width:58%">
                58%
            </div>
        </div>
    </div>
