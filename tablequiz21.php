...
<div class="container">
    <h1 class="text-center">This is page 21 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz22.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">101. I feel comfortable with myself.</td>
                <td style="text-align:center"><input type="radio" name="n3" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="n3" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">102. I wait for others to lead the way.</td>
                <td style="text-align:center"><input type="radio" name="e3" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="e3" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">103. I don't understand people who get emotional.</td>
                <td style="text-align:center"><input type="radio" name="o3" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="o3" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">104. I take no time for others.</td>
                <td style="text-align:center"><input type="radio" name="a3" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="a3" value="1"/></td>
            </tr>
            <tr>
                <td class="questions">105. I break my promises.</td>
                <td style="text-align:center"><input type="radio" name="c3" value="5" required/></td>
                ...
                <td style="text-align:center"><input type="radio" name="c3" value="1"/></td>
            </tr>
            </tbody>
        </table>
    </div>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="21"
                 aria-valuemin="0" aria-valuemax="24" style="width:88%">
                88%
            </div>
        </div>
    </div>
