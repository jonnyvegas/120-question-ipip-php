...
<div class="container">
    <h1 class="text-center">This is page 3 of our quiz.<br> <small>Please answer all questions.</small></h1>
    <br>
...
<form action="tablequiz4.php" method="post" >
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">11. I often feel blue.</td>
            ...
            <tr>
                <td class="questions">12. I take charge.</td>
            ...
            <tr>
                <td class="questions">13. I experience my emotions intensely.</td>
            ...
            <tr>
                <td class="questions">14. I love to help others.</td>
            ...
            <tr>
                <td class="questions">15. I keep my promises.</td>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="3"
                 aria-valuemin="0" aria-valuemax="24" style="width:13%">
                13%
            </div>
        </div>
    </div>
