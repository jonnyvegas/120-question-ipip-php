...
<div class="container">
    <h1 class="text-center">This is page 7 of our quiz.<br> <small>Please continue to answer all questions.</small></h1>
    <br>
...
<form action="tablequiz8.php" method="post">
    <div class="table1">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td class="questions">31. I fear for the worst.</td>
            ...
            <tr>
                <td class="questions">32. I feel comfortable around people.</td>
            ...
            <tr>
                <td class="questions">33. I enjoy wild flights of fantasy.</td>
            ...
            <tr>
                <td class="questions">34. I believe that others have good intentions.</td>
            ...
            <tr>
                <td class="questions">35. I excel in what I do.</td>
...
<div class="container">
    <div class="col-xs-12">
        <div class="progress">
            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="7"
                 aria-valuemin="0" aria-valuemax="24" style="width:29%">
                29%
            </div>
        </div>
    </div>
